        ...
        <div style={{ maxWidth: "900px", margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1px", background: "var(--ink)", border: "1px solid var(--ink)", marginBottom: "1px" }}>
            {DELIVERY_ZONES.map((zone) => (
              <div key={zone.id} style={{ background: "var(--paper)", padding: "40px" }}>
          ...
          {/* Pickup */}
          <div style={{ background: "var(--teal-deep)", color: "var(--paper)", padding: "40px", borderBottom: "none", marginBottom: "64px" }}>
          ...
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "1px", background: "var(--ink)", border: "1px solid var(--ink)" }}>
              {[
                ...
                <div key={num} style={{ background: "var(--paper)", padding: "36px 28px" }}>
