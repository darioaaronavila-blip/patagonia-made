...
export default function ProductCard({ product }: ProductCardProps) {
  return (
    <Link
      ...
      className="fade-in"
    >
      {/* Image area — placeholder until real photography */}
      <div
        style={{
          aspectRatio: "4/5",
          overflow: "hidden",
      ...
      >
        {/* Placeholder fill — will be replaced with <Image> once photography is ready */}
        <div
          style={{
            width: "100%",
            height: "100%",
      ...
      {/* Info — flex-grow pushes this block down consistently across all cards */}
