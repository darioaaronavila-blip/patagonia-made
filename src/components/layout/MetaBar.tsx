...
export default function MetaBar() {
  ...
  const weatherStr = weather
    ? `${weather.temp}°C · ${weather.windspeed} km/h ${getWindDirection(weather.winddirection)}`
    : "—";

  return (
    <div className="metabar-root">
      <div className="metabar-left">
        <span className="metabar-coords" style={{ opacity: 0.6 }}>53°09′S — 70°55′W · PUNTA ARENAS</span>
        <span style={{ opacity: 0.3, display: "var(--sep-display, inline)" }}>|</span>
        ...
        <span className="metabar-delivery" style={{ opacity: 0.75 }}>Hotel delivery before 18:00</span>
      </div>
