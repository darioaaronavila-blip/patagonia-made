  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: "16px", flexWrap: "wrap" }}>
        <span style={{ opacity: 0.6 }}>53°09′S — 70°55′W · PUNTA ARENAS</span>
        ...
        <span style={{ display: "flex", alignItems: "center", gap: "6px" }}>
          <span style={{
            ...
            borderRadius: "50%",
            background: "var(--moss)",
            boxShadow: "0 0 0 2px rgba(74,93,58,0.3)",
        ...
        <span style={{ opacity: 0.3 }}>|</span>
        {time && <span style={{ opacity: 0.75 }}>{time} local</span>}
        {time && <span style={{ opacity: 0.3 }}>|</span>}
        <span style={{ opacity: weather ? 1 : 0.4, transition: "opacity 0.5s" }}>{weatherStr}</span>
        <span style={{ opacity: 0.3 }}>|</span>
        <span style={{ opacity: 0.75 }}>Hotel delivery same day before 18:00</span>
      </div>
      <div style={{ display: "flex", gap: "20px", alignItems: "center", opacity: 0.75 }}>
